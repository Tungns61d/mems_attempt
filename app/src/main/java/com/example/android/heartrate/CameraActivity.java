...
public class CameraActivity extends AppCompatActivity {
   ...
   int imgSize=100000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewport.setMinY(570);
        viewport.setMaxY(620);
        //viewport.setMinX(0);
        ...
        //staticLabelsFormatter.setHorizontalLabels(new String[]{"1","2","3","4"});
    ...
    TextureView.SurfaceTextureListener textureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture surface) {
           ...
           // addEntry();
            ...
            //RedValue=Double.parseDouble(new DecimalFormat("#.###").format(RedValue));
            addRedValue(RedValue);
    ...
    private void calcBPM() {
       ...
       // med = ((int)timedist[14]+(int)timedist[15]+(int)timedist[16])/3;
         med = ((int)timedist[13]+(int)timedist[14]+(int)timedist[15]+(int)timedist[16]+(int)timedist[17])/5;
    ...
    private void addRedValue(int value){
        //chose to display max 100 point on the viewport and scroll to the end
        series.appendData(new DataPoint(lastX++, value),true,dataMaxPoint);
    }
